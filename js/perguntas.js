      ...
      alternativas: [
        {
          ...
          afirmacao: [
            ...
            "No início achou assustador pensar na velocidade na qual a tecnologia está avançando."
        ]
        },
        {
          ...
          afirmacao:  [
            ...
            "No início pensou que IA pode ajudar em tarefas da sua vida.",
            "No início se admirou pela grande inovação que a IA é, e pelo oque ela pode ser útil."
        ]
        },
      ],
    },
      ...
      alternativas: [
        {
          ...
          afirmacao: [
            "Depois, conseguiu utilizar a IA para buscar informações úteis.",
            "Depois, percebeu que a IA pode ajudar a encontrar informações úteis na internet de forma mais rápida e direcionada.",
            "Depois, percebeu que a IA consegue explicar termos complicados de forma simplificada e isso ajudou muito suas pesquisas sobre assuntos complexos."
        ]
        },
        {
          texto:
          ...
          afirmacao: [
            "Assim sentiu mais facilidade em utilizar seus próprios recursos para escrever seu trabalho.",
            "Assim achou que era muito mais fácil procurar por respostas utilizando alguns meios mais tradicionais mesmo que levasse mais tempo.",
            "Assim sentiu um pouco de medo de quais dados pessoais seus a IA poderia utilizar e por isso prefere fazer suas coisas com pouca intromissão da tecnologia."
        ]
        },
      ],
    },
      ...
      alternativas: [
        {
          ...
          afirmacao: [
            "Porém, infelizmente passou a utilizar a IA para fazer todas suas tarefas e agora se sente dependente da IA para tudo.",
            "Porém, infelizmente grande parte de sua vida se tornou relacionada a IA."
        ]
        },
        {
          texto:
          ...
          afirmacao: [
            "Agora percebeu que toda IA reproduz orientações baseadas na empresa que programou e muito do que o chat escrevia não refletia o que pensava e por isso sabe que os textos gerados pela IA devem servir como auxílio e não resultado final.",
            "Agora se tornou conscientizado sobre o uso da IA e passa a dominá-la com especialidade"
        ]
        },
      ],
    },
